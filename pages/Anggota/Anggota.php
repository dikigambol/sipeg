...
ON detail_karyawan.divisi = divisi.id_divisi WHERE divisi.nama_divisi = '$divisi' AND akun_karyawan.id_karyawan NOT IN ($id_user)";
        ...
        <div class="row align-items-center">
            <div class="col-md-12">
                <div class="page-header-title">
                    <h5 class="m-b-10">List Anggota</h5>
                </div>
                <ul class="breadcrumb">
                                            ...
                                            <td>
                                                <div class="dropdown">
                                                    ...
                                                    <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                                                        <a class="dropdown-item" href="dashboard.php?page=detailpegawai&id=<?php echo $data['id_karyawan'] ?>&type=kepala">Detail</a>
                                                    </div>
                                                </div>
                                            </td>
                                        </tr>
